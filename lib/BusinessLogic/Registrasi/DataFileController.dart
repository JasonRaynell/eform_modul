    ...
    try {
      ...
      if (results?.data != null) {
        ...
        try {
          ...
          livenssResponseModel = LivenssResponseModel.fromJson(
              resulthasilLiveness?.data?.body['data']);
          print(
              'INI ADALAH RESOPN MODEL LIVENESS${livenssResponseModel?.score}');
              ...
              Get.dialog(PopoutWrapContent(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Ini Score Anda ${livenssResponseModel?.score}",
                      style: infoStyle,
                      textAlign: TextAlign.center,
                    )
                  ],
            ...
            return Get.dialog(PopoutWrapContent(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Text(
                    "Score anda ${livenssResponseModel?.score}",
                    style: infoStyle,
                    textAlign: TextAlign.center,
                  )
                ],
